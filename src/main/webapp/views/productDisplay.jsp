...
<title>ProductDisplay zenobags</title>
<style>
div{
font-family: ;
	font-size: 1em;
...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">ZENO BAGS</p>
                <div class="list-group">
                    <a href="categoryDropdown/101" class="list-group-item">HANDBAGS</a>
                    <a href="categoryDropdown/102" class="list-group-item">WALLETS</a>
                    <a href="categoryDropdown/103" class="list-group-item">LUGGAGE BAGS</a>
...
<a href="categoryback"><button type="button" class="btn btn-primary" >Back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:8070/zenobags/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8070/zenobags/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8070/zenobags/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8070/zenobags/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
